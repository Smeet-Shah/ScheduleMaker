    ...
    <main className="min-h-screen bg-zinc-50 flex justify-center px-4 py-10">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-sm border border-zinc-100 p-6 md:p-8 space-y-6">
        <header className="space-y-1">
          ...
          <p className="text-sm text-zinc-600">
            Create events, get share links, and reset responses.
          </p>
        </header>
        ...
        <section className="space-y-3">
          <h2 className="text-sm font-medium text-zinc-800">Existing events</h2>
          {events.length === 0 ? (
                ...
                >
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">
                      Share: /e/{event.id} • Summary: /e/{event.id}/summary
                    </div>
                  </div>
                  <button
                    type="button"
